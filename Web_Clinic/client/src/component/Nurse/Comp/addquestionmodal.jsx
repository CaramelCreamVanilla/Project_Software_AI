    ...
    const suretoadd = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                await addQuestion(question,formAnswer).then(async (status)=>{
                    if (status === 200) {
                        Swal.fire({
                            title: "Added!",
                        ...
                        Swal.fire({
                            title: "Failed!",
                            text: "Your question could not be added.",
                            icon: "error"
                        });
                    }
                }).catch((error) => {
                    ...
                    <div className="formaddquestion">
                        <div className="one-group-horizontal">
                            <div className="input-group">
                                ...
                                <input type="text" name="" placeholder="Your Question" required pattern=".{3,150}" onChange={(e) => setQuestion(e.target.value)}/>
                            </div>
                        </div>
                        <div className="one-group-horizontal">
                            <div className="input-group">
                            ...
                            <>
                                <div className="one-group-horizontal">
                                    <div className="input-group">
                                        ...
                                        <input type="text" onChange={handleNumberOfChoicesChange} />
                                    </div>
                                </div>
                            </>
                        )}
